...
bun run --cwd vellum e2e                                            # the browser suite, `e2e/*.e2e.ts`, at the five windows of `e2e/playwright.config.ts`
bun run --cwd vellum e2e -- kit.e2e.ts --project=light-1440         # one suite, one window
