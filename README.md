...
| [vellum](vellum/) | 1.0.0 | Plan the way the reviewer reads: open choices settled first, the plan ordered by what the reviewer is most likely to change, interfaces and files before mechanics, vertical slices each closed by a check, then a fresh session to implement |
