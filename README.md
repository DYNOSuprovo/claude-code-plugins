...
| [vellum](vellum/) | 1.1.0 | Plan at the frontiers and review the plan in the browser: open choices settled first, interfaces and files before mechanics, vertical slices each closed by a check; /vellum:plan opens a planning mode of its own where Claude writes the plan and its mockups, the reviewer comments text, HTML elements and diagrams in a page or approves, and the answer reaches Claude as a prompt |
